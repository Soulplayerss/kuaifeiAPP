<template>
	<view class="myFeedback">
		<AppBar title='我的共享' @goBank="goBank" />
							...
							<view class="commonDataItem">
								...
								<view class="rightInfo">
									...
									<view class="flex justify-between">
										<span>车辆编号：{{item.codeCar}}</span>
										<span style="min-width:100px;">状态：<span
												style="color: #c38513;">{{item.status}}</span></span>
									</view>
									<view class="flex justify-between">
										<span>开始时间：{{item.startTime}}</span>
										<span style="min-width:100px;">收益：{{item.battery}}电池</span>
									</view>
									<view class="flex justify-between">
										<span>结束时间：{{item.endTime}}</span>
										<span style="min-width:100px;">计费：{{item.billing}}电池</span>
									</view>
								</view>
							</view>
